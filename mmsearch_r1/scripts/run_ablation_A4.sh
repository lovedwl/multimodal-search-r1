#!/bin/bash
# A4 消融: 多轮搜索的影响
# max_gen_round=1 (单轮) vs 3 (多轮)
#
# 运行: bash mmsearch_r1/scripts/run_ablation_A4.sh 1
#       bash mmsearch_r1/scripts/run_ablation_A4.sh 3
...
# ====== 实验配置 ======
MAX_ROUNDS=${1:-3}
WANDB_EXP_NAME="ablation_A4_rounds_${MAX_ROUNDS}"
N_GPUS=3
...
python3 -m mmsearch_r1.trainer.multimodal.main_ppo \
    ...
    actor_rollout_ref.rollout.max_gen_round=$MAX_ROUNDS \
